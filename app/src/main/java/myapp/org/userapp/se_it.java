...
public class se_it extends AppCompatActivity {

    CardView set_u1,set_u2,set_u3,set_prac,set_lab,set_que;

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.se_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(se_it.this, levels4b_it.class);
        ...
        set_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(se_it.this, set_que_main.class);
                startActivity(intent);
            }
        });
        ...
        set_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(se_it.this, set_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        set_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(se_it.this, set_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        set_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(se_it.this, set_u3_main.class);
                startActivity(intent);
            }
        });
