...
public class physics_it extends AppCompatActivity {

    CardView phy_prac,phy_u1,phy_u2,phy_u3,phy_u4,phy_u5,phy_u6;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.physics_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(physics_it.this, levels1_it.class);
        ...
        phy_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(physics_it.this, phy_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        phy_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(physics_it.this, phy_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        phy_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(physics_it.this, phy_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        phy_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(physics_it.this, phy_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        phy_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(physics_it.this, phy_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        phy_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(physics_it.this, phy_u6_main.class);
                startActivity(intent);
            }
        });
