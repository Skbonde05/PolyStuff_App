    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(pdtmp_it.this, levels3_it.class);
        ...
        dtmp_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(pdtmp_it.this, dtmp_que_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        dtmp_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(pdtmp_it.this, dtmp_u6_main.class);
                startActivity(intent);
            }
        });
