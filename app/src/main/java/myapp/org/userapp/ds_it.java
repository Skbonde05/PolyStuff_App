...
public class ds_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ds_it.this, levels3_it.class);
        ...
        ds_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ds_it.this, ds_que_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        ds_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(ds_it.this, ds_u6_main.class);
                startActivity(intent);
            }
        });
