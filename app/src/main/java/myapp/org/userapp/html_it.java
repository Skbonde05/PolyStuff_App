...
public class html_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.html_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(html_it.this, levels2_it.class);
        ...
        html_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(html_it.this, html_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        html_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(html_it.this, html_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        html_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(html_it.this, html_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        html_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(html_it.this, html_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        html_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(html_it.this, html_u5_main.class);
                startActivity(intent);
            }
        });
