    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(foe_it.this, levels2_it.class);
        ...
        foe_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(foe_it.this, foe_que_main.class);
                startActivity(intent);
            }
        });
        ...
        foe_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(foe_it.this, foe_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        foe_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(foe_it.this, foe_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        foe_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(foe_it.this, foe_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        foe_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(foe_it.this, foe_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        foe_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(foe_it.this, foe_u5_main.class);
                startActivity(intent);
            }
        });
    }
