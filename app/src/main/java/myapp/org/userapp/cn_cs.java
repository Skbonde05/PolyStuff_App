...
public class cn_cs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(cn_cs.this, levels3.class);
        ...
        cn_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(cn_cs.this, cn_que_main.class);
                startActivity(intent);
            }
        });
        ...
        cn_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(cn_cs.this, cn_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        cn_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(cn_cs.this, cn_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        cn_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(cn_cs.this, cn_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        cn_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(cn_cs.this, cn_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        cn_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(cn_cs.this, cn_u5_main.class);
                startActivity(intent);
            }
        });
