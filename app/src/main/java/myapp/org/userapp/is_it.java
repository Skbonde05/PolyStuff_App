...
public class is_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(is_it.this, levels5_it.class);
        ...
        cs_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(is_it.this, cs_que_main.class);
                startActivity(intent);
            }
        });
        ...
        cs_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(is_it.this, cs_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        cs_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(is_it.this, cs_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        cs_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(is_it.this, cs_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        cs_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(is_it.this, cs_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        cs_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(is_it.this, cs_u5_main.class);
                startActivity(intent);
            }
        });
