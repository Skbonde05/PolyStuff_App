...
public class oop_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oop_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(oop_it.this, levels3_it.class);
        ...
        oop_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(oop_it.this, oop_que_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        oop_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(oop_it.this, oop_u6_main.class);
                startActivity(intent);
            }
        });
