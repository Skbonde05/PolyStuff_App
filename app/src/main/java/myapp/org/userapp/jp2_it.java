...
public class jp2_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jp2_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(jp2_it.this, levels4b_it.class);
        ...
        jp2_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(jp2_it.this, jp2_que_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        jp2_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp2_it.this, jp2_u6_main.class);
                startActivity(intent);
            }
        });
    }
