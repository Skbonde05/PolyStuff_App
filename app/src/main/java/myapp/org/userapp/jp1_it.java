...
public class jp1_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jp1_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(jp1_it.this, levels3.class);
        ...
        jp1_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(jp1_it.this, jp1_que_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        jp1_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(jp1_it.this, jp1_u6_main.class);
                startActivity(intent);
            }
        });
