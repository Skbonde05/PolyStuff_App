...
public class edp_it extends AppCompatActivity {

    CardView edp_lab,edp_u1,edp_u2,edp_u3,edp_u4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.edp_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(edp_it.this, levels4_it.class);
        ...
        edp_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(edp_it.this, edp_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        edp_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(edp_it.this, edp_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        edp_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(edp_it.this, edp_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        edp_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(edp_it.this, edp_u4_main.class);
                startActivity(intent);
            }
        });
    }
