...
public class dbms_it extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dbms_it);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(dbms_it.this, levels4b.class);
        ...
        rdbms_que.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(dbms_it.this, rdbms_que_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u1_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u2_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u3_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u4_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u5_main.class);
                startActivity(intent);
            }
        });
        ...
        rdbms_u6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open jp1_u1_main activity
                Intent intent = new Intent(dbms_it.this, rdbms_u6_main.class);
                startActivity(intent);
            }
        });
